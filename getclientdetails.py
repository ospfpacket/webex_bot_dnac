...
#from webex_bot.models.command import Response
import requests
import json

class GetClientDetails(Command):
    def __init__(self):
        super().__init__(
            command_keyword="client",
    ...
    def execute(self, message, attachment_action, activity):
        ...
        payload = ""
        headers = {
            'Authorization': '<Basic64 Auth here>'     #Basic64 Here
        }
        ...
        #This splits the message and allows interaction in a teams space vs. a direct message only
        ...
        url = "https://<dnac url here:port>/dna/intent/api/v1/client-detail?timestamp=1669166580000&macAddress=" + mac_addr     #DNAC URL and Port here
